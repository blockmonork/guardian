...
<head>
    ...
    <link rel="icon" href="<?php assets('favicon') ?>">
    <title><?php echo $loginPageTitle; ?></title>

    <link href="<?php assets('google_fonts'); ?>" rel="stylesheet">
    <link rel="stylesheet" href="<?php assets('materialize_css') ?>" media="screen,projection" type="text/css">
    <link rel="stylesheet" type="text/css" href="<?php assets('c_css') ?>">
</head>
...
<body>
    ...
    <script type="text/JavaScript" src="<?php assets('crypto') ?>"></script>
    <script type="text/JavaScript" src="<?php assets('fn') ?>"></script>
</body>
